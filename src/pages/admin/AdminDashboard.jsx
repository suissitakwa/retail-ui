    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white shadow-md p-6 rounded-lg border">
          ...
          <p className="text-gray-600 mb-3">Add, edit, or delete products.</p>
        ...
        <div className="bg-white shadow-md p-6 rounded-lg border">
          ...
          <p className="text-gray-600 mb-3">View and update order statuses.</p>
        ...
        <div className="bg-white shadow-md p-6 rounded-lg border">
          ...
          <p className="text-gray-600 mb-3">View all customers and admins.</p>
          <button className="btn-primary" onClick={() => navigate("/admin/customers")}>
            Open
          </button>
        </div>
      </div>
